        ...
        <style type="text/css">
            * {
            ...
            .banner {
                width: 100%;
                height: 100vh;
                background-image: linear-gradient(rgba(253, 114, 0, 0.848),rgba(0,0,0,0.75)),url(bg.png);
...
<body>
    <div class="banner">
        ...
        <div class="content">
            <div class="text">
                ...
                <br>
                <p>  If you're just getting started learning to code, Codecademy is a great way to get a sense for what coding is and how it works! </p>
                <br>
                <div>
    ...
    <footer>
        <center> Designed and Developed by MUGIL RAJ S A(212223220062) </center>
    </footer>
</body>
</html>
        ...
        <div class="image">
            <table cellspacing="20"> 
                <tr align="center">
                    ...
                    <td> <img src="DHONI.png"> </td>
                    <td> <img src="KOHLI.png"> </td>
                    <td> <img src="JADEJA.png"> </td>
                    <td> <img src="HARDIK.png"> </td>
                    <td> <img src="RAHUL.png"> </td>
                </tr>
                <tr align="center">
                    <th> MUGIL RAJ S A </th>
                    <th> M S Dhoni </th>
        ...
        <style type="text/css">
            * {
            ...
            .banner {
                width: 100%;
                height: 100vh;
                background-image: linear-gradient(rgba(255, 135, 6, 0.886),rgba(0,0,0,0.75)),url(background.jpg);
                background-size: cover;
                background-position: center;
            }
            .navbar {
    ...
    <div class="banner">
        ...
        <div class="box">
            ...
            <div class="box-2"> 
                ...
                <p> <span>Address</span> : 3/53,Marudhanapalli(vill&post),Krishnagiri-635107 </p>
                <p> <span>Email</span> : rajmugil8@gmail.com </p>
                <p> <span>Phone</span> : 9342893087 </p>
            </div>
        </div>
    </div>
    <footer>
